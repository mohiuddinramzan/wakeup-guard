...
3. **ভয়েস রিকগনিশন (`🎙️ বলে দেখান`)** নির্ভর করে ডিভাইসের WebView-তে Speech Recognition সমর্থন ও ইন্টারনেট/মাইক্রোফোন পারমিশনের উপর। "বলা শুরু করুন" চাপলে এখন সরাসরি মাইক্রোফোন পারমিশন চাওয়া হয় (আগে এটা চাওয়া হতো না বলেই "মাইক্রোফোন সমস্যা বা অনুমতি নেই" এরর আসছিল)। **তবে সৎভাবে বলা দরকার:** অনেক অ্যান্ড্রয়েড WebView-তে ব্রাউজারের Speech Recognition backend আসলে কাজই করে না (এটা শুধু Chrome অ্যাপে ভালোভাবে কাজ করে) — পারমিশন ঠিক থাকা সত্ত্বেও যদি এটা কাজ না করে, সেটা এই প্ল্যাটফর্ম-লেভেল সীমাবদ্ধতার লক্ষণ, এবং তখন সেই অ্যালার্মের জন্য এই চ্যালেঞ্জটা বাদ দিয়ে বাকিগুলো (টাইপ/পাসওয়ার্ড/অংক/ঝাঁকানো/হোল্ড/প্যাটার্ন) ব্যবহার করাই ভালো। সমর্থন একদমই না থাকলে অ্যাপ নিজে থেকেই টাইপ-ফলব্যাক দেখাবে।
