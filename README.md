...
- 🔔 প্রতিটি অ্যালার্মের জন্য আলাদা সাউন্ড বাছাই: ডিফল্ট Web Audio সাইরেন, অথবা ফোনের ফাইল-পিকার দিয়ে নিজের ডাউনলোড করা অডিও ফাইল/ফোনের রিংটোন বাছাই করা (নিচে "কাস্টম রিংটোন" অংশে বিস্তারিত ও সীমাবদ্ধতা), সাথে ভাইব্রেশন
...
## কাস্টম রিংটোন / ডাউনলোড করা অডিও দিয়ে অ্যালার্ম সাউন্ড

অ্যালার্ম এডিট স্ক্রিনে "🔔 অ্যালার্ম সাউন্ড" অংশে "🎵 কাস্টম অডিও" বাছাই করে ফোনের ফাইল-পিকার থেকে যেকোনো অডিও ফাইল বেছে নেওয়া যায়। এটা প্লেইন `<input type="file" accept="audio/*">` ব্যবহার করে — কোনো বাড়তি নেটিভ প্লাগিন লাগে না।

**সৎভাবে বলা দরকার এমন কয়েকটা জিনিস:**

1. **ফোনের ডিফল্ট রিংটোন/অ্যালার্ম সাউন্ড সরাসরি "তালিকা থেকে বাছাই" করার মতো কোনো API ব্রাউজার/WebView-এ নেই।** তবে সাধারণত Android-এর নিজস্ব ফাইল/মিডিয়া পিকার (যেটা এই `<input type="file">` চাপলে খোলে) নিজে থেকেই Ringtones, Notifications, Alarms, Music-এর মতো ক্যাটাগরি দেখায় — সেখান থেকে ফোনের বিল্ট-ইন রিংটোনও বেছে নেওয়া সাধারণত সম্ভব হওয়ার কথা। এটা আমার Android-এর সাধারণ আচরণ সম্পর্কে ধারণার ভিত্তিতে বলা, **আমি নিজে তোমার ডিভাইসে এটা চালিয়ে দেখতে পারিনি** — ডিভাইস/অ্যান্ড্রয়েড ভার্সনভেদে পিকারের চেহারা ভিন্ন হতে পারে, নিজে চেক করে দেখো।
2. **বাছাই করা অডিও ফাইল localStorage-এ (base64 হিসেবে) সংরক্ষিত হয়**, যেটার মোট ক্ষমতা ডিভাইসভেদে সাধারণত ৫-১০ MB-এর মধ্যে, সব অ্যালার্ম মিলিয়ে ভাগ হয়। তাই ৩ MB-এর বেশি ফাইল অ্যাপ নিজে থেকেই আটকে দেবে, আর একাধিক অ্যালার্মে বড় কাস্টম সাউন্ড দিলে "সংরক্ষণ ব্যর্থ" এরর আসতে পারে — তখন ছোট ক্লিপ (৩০ সেকেন্ড – ১ মিনিট) ব্যবহার করো।
3. **সবচেয়ে গুরুত্বপূর্ণ সীমাবদ্ধতা:** এই কাস্টম সাউন্ড শুধু তখনই বাজবে যখন অ্যাপ ফোরগ্রাউন্ডে খোলা থাকবে (নিজস্ব JS টাইমার দিয়ে ফায়ার করার সময়, বা টেস্ট বাটনে)। স্ক্রিন বন্ধ/অ্যাপ বন্ধ অবস্থায় যে OS নোটিফিকেশন আসে (`@capacitor/local-notifications` দিয়ে), সেটা Android-এর নিজস্ব ডিফল্ট নোটিফিকেশন সাউন্ড ব্যবহার করবে — কারণ ব্যবহারকারীর রানটাইমে বাছাই করা arbitrary অডিও ফাইলকে নোটিফিকেশন চ্যানেলের সাউন্ড হিসেবে বসানোর জন্য অ্যাপ বিল্ড করার সময় সেটাকে নেটিভ রিসোর্স হিসেবে বান্ডেল করা লাগে, যা বান্ডলার-ছাড়া এই সেটআপে করা যায়নি। অর্থাৎ: অ্যাপ খোলা থাকলে কাস্টম গান/রিংটোন বাজবে, বন্ধ থাকলে ফোনের ডিফল্ট নোটিফিকেশন সাউন্ড বাজবে।
